...
using StudentAffairsSystem.Authorization;
...
namespace StudentAffairsSystem
{
    public class Program
    {
        ...
        private static void AddServices(WebApplicationBuilder builder)
        {
            ...
            string migrationsAssembly = typeof(Program).GetTypeInfo().Assembly.GetName().Name; //StudentAffairsSystem
        ...
        private static void ConfigureRequestPipeline(WebApplication app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - StudentAffairsSystem";
